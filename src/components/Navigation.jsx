...
const Navigation = () => {
    ...
    return (
        <nav className="fixed bottom-0 left-0 w-full bg-[var(--color-bg-card)]/90 backdrop-blur-md border-t border-[var(--color-border)] pb-8 pt-2 px-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-50 md:hidden animate-slideUp transition-smooth">
